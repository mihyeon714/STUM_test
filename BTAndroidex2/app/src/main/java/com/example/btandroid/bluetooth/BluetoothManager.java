...
public class BluetoothManager {
    ...
    private boolean mIsServiceStopped = false;  //추가됨
    ...
    public BluetoothManager(Context context, Handler handler) {
        ...
        //setState(STATE_NONE); //가진코드처럼해보겠다.//이거쓰면 안드로이드 죽어요 ㅋㅋㅋㅋㅋㅋㅋㅋㅋ
        mHandler = handler;
    }
    ...
    public synchronized void start() {
        ...
        // Start the thread to listen on a BluetoothServerSocket //추가됨
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) { //매개변수에 소켓타입이 빠짐//수정됨
        ...
        Message msg = mHandler.obtainMessage(MESSAGE_DEVICE_NAME);//수정됨//MainActivity.~으로되있었음
    ...
    private void reserveRetryConnect() {  //함수가추가됨
    ...
    private void sendMessage() {
        ...
        Log.d("tag-sendMessage()", "시간보내기가 되었도다"+strnow);
    ...
    }	// End of class AcceptThread//연결되기직전임
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                BluetoothManager.this.start(); //추가됨
                return;
            }
                    ...
                    while(i < bytes){
                        ...
                        if(chr == 0x0a){
                            ...
                            if(pRcvBuffer > 2)
                            {
                               ...
                               // mHandler.obtainMessage(MESSAGE_READ, pRcvBuffer - -1, -1, RcvBuffer).sendToTarget();
        ...
        public void write(byte[] buffer) {
            try {
                ...
                // Disabled: Share the sent message back to the main thread
                 mHandler.obtainMessage(MESSAGE_WRITE, -1, -1, buffer).sendToTarget(); //MH주석풀엇음
